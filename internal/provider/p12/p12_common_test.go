...
// GenerateP12TestCertAndKey generates a self-signed certificate and private key for P12 testing.
// Returns the private key PEM, certificate PEM, and an additional chain certificate PEM.
func GenerateP12TestCertAndKey(t *testing.T) (string, string, string) {
